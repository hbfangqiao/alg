...
public class P8StringToIntegerAtoi {
    public static void main(String[] args) {
        ...
        System.out.println(solution.myAtoi("123-"));//123
        ...
        System.out.println(solution.myAtoi("+-42"));//0
        System.out.println(solution.myAtoi(""));//0
        System.out.println(solution.myAtoi("  00042"));//42
        System.out.println(solution.myAtoi("  - 42"));//0
        System.out.println(solution.myAtoi("+1"));//1
        System.out.println(solution.myAtoi(" w 42"));//0
        System.out.println(solution.myAtoi(" 42 42"));//42
        System.out.println(solution.myAtoi("00000-42a1234"));//0
    ...
    class Solution {
        public int myAtoi(String s) {
            ...
            boolean negtiveCheck = false;
            char[] chars = s.toCharArray();
            List<Character> characters = new ArrayList<>();
            for (int i = 0; i <chars.length ; i++) {
                if (characters.size() == 0 && chars[i] == ' '){
                    continue;
                }
                characters.add(chars[i]);
            }
            for (char ch : characters) {
                if (!negtiveCheck && (ch == '-' || ch == '+')) {
                    negtive = ch == '-';
                    negtiveCheck = true;
                    continue;
                }
            ...
            long l =negtive ? -1 * Long.parseLong(buffer.toString()) : Long.parseLong(buffer.toString());
